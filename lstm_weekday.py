...
data=[]
for i in range(1,8):
    tmpdata=dataset[dataset['day_of_week']==i]
    # tmpdata=tmpdata[['r_date','date','cnt']]
    print(tmpdata)
...
# # fit network
# history = model.fit(train_X, train_y, epochs=70, batch_size=100, verbose=2, shuffle=False)
# # plot history
...
# inv_y = inv_y[:,-1]
# rmse =mean_squared_error(t_y, inv_y)
# print('train RMSE: %.3f' % rmse)
# pyplot.plot(inv_y, label='preds')
# pyplot.plot(t_y, label='true')
# pyplot.legend()
# pyplot.show()
#
